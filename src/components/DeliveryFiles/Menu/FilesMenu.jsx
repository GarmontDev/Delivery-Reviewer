    ...
    <>
      <div className="flex pt-2 pr-2">
        <Menu
          ...
          right
          className="absolute top-2 right-0 bg-slate-800 rounded-tl-lg pt-6"
          itemClassName="text-white tracking-wider mb-2 px-2 pb-1 w-4/6 rounded-md"
          crossButtonClassName="absolute top-0 right-0 mt-4 bg-red-400 rounded-sm"
        >
          {employee.admin && (
            <a id="update-incidents-button" href="#" className="menu-item" onClick={() => refreshFilesState()}>
